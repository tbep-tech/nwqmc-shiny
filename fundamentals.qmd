...
1. Shiny recognizes that the `input$n` value has changed and re-runs any pieces of `server` that use that value.   
...
This is a simle example that isn't very informative, but it gives you a sense of how showcase made works.  It will be more useful with a more comlex app. 
