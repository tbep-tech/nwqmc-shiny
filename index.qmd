...
* Kickoff Slides: [Link](){target="_blank"}
...
Dr. Kateri Salk is a limnologist and biogeochemist whose research focuses on data science approaches to solve water quality challenges from local to continental scales. To date, her work has focused on management-relevant water quality issues including nutrient cycling, harmful algal blooms, greenhouse gases, and PFAS contamination. She has worked in the academic and consulting settings, leading efforts in fundamental research and management support for agencies including the Environmental Protection Agency, The Nature Conservancy, and state environmental agencies. As a project manager and subject matter expert, Dr. Salk currently leads projects involving nutrient criteria development and assessment in surface waters as well as predictive statistical modeling of water quality. Dr. Salk specializes in data analytics in the aquatic sciences, including empirical and mechanistic modeling, data management for research teams, course design and instruction, and interactive data dashboard development. [GitHub](https://github.com/KateriSalk){target="_blank"}, [Scholar](https://scholar.google.com/citations?user=DsFFoEUAAAAJ&hl=en&authuser=1&oi=ao){target="_blank"}